...
try:
    from scripts.utils import parse_simple_frontmatter, split_skill_md
except ModuleNotFoundError:
    from utils import parse_simple_frontmatter, split_skill_md
...
def validate_skill(skill_path):
    """Validate basic Codex skill structure and frontmatter."""
