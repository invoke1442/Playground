...
The package models Express/Koa-style XSS taint flow:

- Sources: `req.query`, `req.body`, `ctx.request.body`
- Sinks: `res.send(...)`, `res.write(...)`, and Koa `ctx.body`
...
- JS extend files should export a CommonJS object, for example:
