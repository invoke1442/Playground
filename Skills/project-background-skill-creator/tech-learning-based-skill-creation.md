...
根据官方文档/home/nyn/Desktop/Projects/Agents/playground/Skills/tech-learning/workspace/alibaba-dsl-learning/official-docs，学习 阿里 DSL，在/home/nyn/Desktop/Projects/Agents/playground/Skills/tech-learning/workspace/alibaba-dsl-learning/workspace目录下进行迭代测试学习，在/home/nyn/Desktop/Projects/Agents/playground/Skills/tech-learning/workspace/alibaba-dsl-learning/alibaba-dsl-skill/alibaba-dsl-skill目录下生成alibaba-dsl-skill
...
2. 实现你的规划。最终，你应该形成一个 Skill，能面向 Web 污点漏洞，开箱即用地提供关于 阿里 DSL 的所有知识。
3. 多轮评测、改进的实现的skill：
    - 直接从内容上评估Skill.md: 
